...
public class adapter_fragment2_listitem extends BaseAdapter {
    private javaBean_fragment2 data = new javaBean_fragment2();
    private Context context;
    public adapter_fragment2_listitem(javaBean_fragment2 data, Context context){
        this.data = data;
