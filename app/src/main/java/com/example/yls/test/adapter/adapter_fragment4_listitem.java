...
public class adapter_fragment4_listitem extends BaseAdapter {
    private javaBean_fragment4 data = new javaBean_fragment4();
    private Context context;
    public adapter_fragment4_listitem(javaBean_fragment4 data, Context context){
        this.data = data;
